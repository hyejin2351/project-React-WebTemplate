      ...
      <div className={classes.root}>
            ...
            <div className={classes.paper_wrap}>
              ...
              <Paper
                className={classNames(
                  classes.paper,
                  classes.firstline_paper_height
                )}
              >
                <Grid
                  container
        ...
        <Grid item xs={12}>
          <div className={classes.paper_wrap}>
            ...
            <Paper className={classes.paper}>
              <Typography variant="body1" className={classes.out_text}>
                서비스를 더 이상 이용하고 싶지 않다면 여기서 계정을 탈퇴할 수
                있습니다.
              </Typography>
              <Button
                variant="contained"
